...
export async function deployLibraryContracts() {
  const [
    ...
    ethers.getContractFactory('InsuranceFundWalletUpgrade'),
  ...
  const [
    ...
    (await InsuranceFundWalletUpgrade.deploy()).deployed(),
  ...
  return ethers.getContractFactory('Exchange_v4', {
    libraries: {
      ...
      InsuranceFundWalletUpgrade: insuranceFundWalletUpgrade.address,
