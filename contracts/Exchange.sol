...
import { FundingMultipliers, Market, OraclePrice, Order, OrderBookTrade, Withdrawal } from './libraries/Structs.sol';
...
contract Exchange_v4 is IExchange, Owned {
  ...
  mapping(string => FundingMultipliers[]) _fundingMultipliersByBaseAssetSymbol;
